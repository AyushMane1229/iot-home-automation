...
#define BLYNK_TEMPLATE_ID       "TMPL34D51Y_IT"
#define BLYNK_TEMPLATE_NAME     "Home Automation"
#define BLYNK_AUTH_TOKEN        "Hv6al7gkAsWeL-OWlDpb7IiUzMjYuBfm"
//Header files
#include <SPI.h>
#include <Ethernet.h>
...
{ /* read the volume and compare it with 2000 ltr, inlet valve is off */
...
{ 
  ...
  /* to connect device continuosly tothe cloud */
...
void loop(void) 
{
  /* read the value from LDR and control LED brightness */
   ...
   temp = String ( read_temperature() , 2);// read after 2 point( readind 2 fields)
   lcd.setCursor(2,0);
   lcd.print(temp); 
...
/* to connect the device continuosly to the cloud */
   Blynk.run();
   /* turn on timer */
   timer.run();    
